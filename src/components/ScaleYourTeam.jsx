        ...
        <section className='bg-[#05164D] py-16 md:py-20 relative'>
            ...
            <div className='container px-4 lg:px-0'>
                <div className=" flex flex-col md:flex-row items-center justify-between">
                    <div className='flex flex-col gap-4 '>
                        ...
                        <div className='flex items-center gap-4 mt-4 lg:mt-5 mb-8'>
                    ...
                    <div className='w-full md:w-fit'>
                        <div className='flex flex-col items-start gap-4'>
                            <div className='flex items-center w-full md:w-fit gap-4'>
                                ...
                                {/* <!-- Card --> */}
                                <div
                                    className="relative w-full md:w-fit overflow-hidden rounded-xl
           ...
           shadow-[inset_0_0_30px_rgba(0,0,0,0.08)]"
                                >
                                    {/* <!-- Subtle inner glow --> */}
                                    <div
                                        className="pointer-events-none absolute inset-0 rounded-[20px] bg-linear-to-br "
                                    ></div>

                                    {/* <!-- Content --> */}
                                    <div className="relative z-10">
                                        <div className="text-[28px] font-semibold leading-none tracking-[-2px] text-white">
                                            94%
                                        </div>

                                        <div className="mt-4  text-[10px] font-semibold leading-[1.35] text-white">
                                            Engagements delivered<br />
                                            on time
                                        </div>
                                    </div>
                                    <div className="pointer-events-none absolute -right-2 -bottom-5 h-full w-20 rounded-full blur-2xl opacity-60 bg-[radial-gradient(circle,#6AA0FF80_100%,#40609980_100%)] "></div>
                                </div>
                                {/* <!-- Card --> */}
                                <div
                                    className="relative w-full md:w-fit overflow-hidden z-50 rounded-xl
           border border-[#6AA0FF80]
           bg-[#071B5E]
           px-5 py-4
           shadow-[inset_0_0_30px_rgba(0,0,0,0.08)]"
                            ...
                            <div className='flex  overflow-hidden items-center gap-2.5 w-full py-6 px-5 bg-[#071B5E] border border-[#6AA0FF80] rounded-xl relative z-50'>
